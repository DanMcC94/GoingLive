...
function About() {
  return (
    <div>
      <Hero backgroundImage="https://i.pinimg.com/originals/90/ce/c4/90cec49512214ec2a09d11c761ef7f95.jpg">
        <h1>Going Live!</h1>
        <h2>Find Top Streaming Games and Gain Your Audience!</h2>
      </Hero>
      <Container style={{ marginTop: 30 }}>
        <Row>
          <Col size="md-12">
            <h1>Welcome To Going Live!</h1>
          </Col>
        </Row>
        <Row>
          <Col size="md-12">
